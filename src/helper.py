...
def extract_module_info_from_json(json_file):
    ...
    for module in module_list:
        module_info = {"courseName": module["moduleCode"] + " " + module["title"]}
...
if __name__ == "__main__":
    ...
    # Save extracted module information to another JSON file
    save_to_file(extracted_modules, 'extracted_modules.json')
